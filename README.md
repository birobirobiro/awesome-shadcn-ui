...
| extension-js sidebar-shadcn | Browser extension side panel starter built with shadcn/ui, Tailwind, and Radix primitives, runs in Chrome, Edge, and Firefox from one manifest. | [Link](https://github.com/extension-js/examples/tree/main/examples/sidebar-shadcn) |
