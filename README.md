...
| nextjs-saas-starter | Production-ready SaaS starter with self-contained auth (Google/GitHub OAuth and email/password, no auth vendor), Stripe subscriptions, teams, and Postgres/Drizzle. Built with Next.js 15, Tailwind CSS v4, and shadcn/ui.[Demo](https://saas-startup.mailkite.dev) | [Link](https://github.com/mailkite/saas-startup) | 2026-07-17 |
