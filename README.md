...
| planes | Animated React components on the shadcn registry model, built with Motion and Tailwind: AI chat and agent UI, carousels, pickers and controls, text effects, and WebGL backdrops. Eleven components are free; the rest are Pro. | [Link](https://useplanes.com) |
