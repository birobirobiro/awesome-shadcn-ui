...
| keyline-icons | 503 MIT-licensed icons in stroke, duotone and fill, drawn on one 24×24 grid. Installable with the shadcn CLI, with a React package matching lucide's API. | [Link](https://keylineicons.com/) |
