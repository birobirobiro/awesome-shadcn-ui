...
| Authier | Freemium, early-stage open-source password manager and TOTP vault for browsers and the web; its interfaces are built with shadcn/ui and support client-side encrypted sync and autofill, but it has not been independently audited. | [Link](https://www.authier.pm/) |
