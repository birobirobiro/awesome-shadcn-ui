...
| blockdex | Item-level search across public shadcn/ui registries that shows each component's install command, dependencies, and whether it is free, paid, or no longer available. | [Link](https://blockdex.thecompound.tech) |
