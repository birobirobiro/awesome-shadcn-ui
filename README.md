...
| extension-js sidebar-shadcn | Browser extension side panel starter for Chrome, Edge, and Firefox from a single manifest, built with shadcn/ui, Tailwind, and Radix primitives. | [Link](https://github.com/extension-js/examples/tree/main/examples/sidebar-shadcn) |
