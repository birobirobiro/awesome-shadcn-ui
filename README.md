...
| Skrewww | Open-source React and TypeScript design system with a shadcn-compatible registry, token-driven Shape/Surface modes, and machine-readable contracts for coding agents; the paired Figma library is free, with an optional paid Pro tier. | [Link](https://skrewww.com) |
