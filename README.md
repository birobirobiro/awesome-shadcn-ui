...
| Name | Description | Link | Date |
| ------------------ | ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------ | ---------- |
| 000h | MIT-licensed shadcn registry of React components with organic shapes and adjustable motion, covering core UI, charts, drawers, text effects, animated backgrounds and WebGL sculptures. | [Link](https://000h.cojeev.com/) |
