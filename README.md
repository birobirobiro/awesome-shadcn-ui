...
| nextjs-shadcn-cloudflare | This is a minimal Next.js 14 application with shadcn-ui components, configured to export static files (HTML, CSS, JS) and deploy them to Cloudflare Worker using the static assets feature. | [Link](https://github.com/yasirharis/nextjs-shadcn-cloudflare) | 2026-07-19 |
