...
| 8bit/cnlibs | Retro pixel-style take on the shadcn/ui components with notched pixel corners and borders, built on Base UI and installable from its own shadcn registry along with 40+ themes. | [Link](https://8bit.cnlibs.com/) |
