...
| better-design | A shadcn registry of complete design systems, each installable with its own tokens and 200+ components, plus an MCP server that helps coding agents pick and install one; free, with a paid Pro plan for private brand guidelines. | [Link](https://better-design.com) |
