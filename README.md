...
| ascii/cnlibs | The shadcn/ui components redrawn as monospace text, with frames made of ASCII characters on a single grid, built on Base UI and installable from its own shadcn registry. | [Link](https://ascii.cnlibs.com/) |
