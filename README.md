...
| reely | Movie and TV discovery and tracking app on the TMDB API — trending rails, live-applying filters (tri-state genres, rating, runtime, year, language, certification, streaming provider), a ⌘K command palette, watchlist and watch history. Interface built on shadcn/ui with Tailwind CSS 4, Next.js 16 and React 19. | [Link](https://www.reely.space) |
