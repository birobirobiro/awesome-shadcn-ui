...
| BlockDex | Item-level search across every public shadcn/ui registry: find the component, not the library, with its install command, its dependencies, and whether it is still free and still exists. | [Link](https://blockdex.kynth.studio) |
