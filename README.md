...
| PDFx — shadcn/ui for React PDFs | Copy-Paste PDF Components | shadcn/ui-style PDF component library for React. Copy-paste components built on @react-pdf/renderer run pdfx add invoice and own the code. | [Link](https://github.com/akii09/pdfx) |
