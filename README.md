...
| data-table-filters | Data tables for React and shadcn/ui: faceted filters, sorting, infinite scroll, and a row detail sheet. Installed as source with the shadcn CLI, so the code is yours to change. | [Link](https://github.com/openstatusHQ/data-table-filters) |
